  ...
  return (
    <div className="surfaces">
      <section className="section">
        ...
        <p>Lorsque la fonction est exprimée sous la forme canonique :</p>
        <BlockMath math="f(x) = a(x - \alpha)^2 + \beta" />
        <p>
          l’axe de symétrie de la parabole est une droite verticale passant par
          l’abscisse du sommet.
        </p>
        <p>L’axe de symétrie est donc la droite :</p>
