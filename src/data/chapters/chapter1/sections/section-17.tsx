  ...
  return (
    <div className="surfaces">
      <section className="section">
        ...
        <p>
          On applique ici le théorème des racines rationnelles pour tester les
          valeurs qui pourraient être des racines évidentes d’un polynôme :
        </p>
        ...
        <p>
          Les diviseurs de <InlineMath math="d = 6" /> sont : 1, 2, 3, 6
        </p>
        <p>
          Les diviseurs de <InlineMath math="a = 2" /> sont : 1, 2
        </p>

        <p>Les candidats pour les racines sont donc :</p>
        <BlockMath
          math={String.raw`\pm1,\ \pm2,\ \pm3,\ \pm6,\ \pm\frac{1}{2},\ \pm\frac{3}{2}`}
        />
        ...
        <BlockMath
          math={String.raw`x_1 = \frac{1}{2}, \quad x_2 = -2, \quad x_3 = 3`}
        />
      </section>
    </div>
  );
