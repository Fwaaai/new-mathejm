      ...
      <section className="section">
        ...
        <ol className="list-1">
          <li>
            ...
            <p>
              Prenons un exemple : <InlineMath math="f(x) = -2x^2 + 5x + 3" />
            </p>
            ...
            <img
              src={table3}
              className="img"
              alt="Tableau de signes modèle pour delta > 0"
            />
            <p>Qui sera donc :</p>
            <img
              src={table4}
              className="img"
              alt="Tableau de signes complété pour delta > 0"
            />
          </li>
          ...
          <li>
            ...
            <p>
              Prenons un exemple : <InlineMath math="f(x) = -x^2 + 4x - 4" />
            </p>
            ...
            />
            <p>
              La racine double est donc <InlineMath math="2" />.
            </p>
            <p>On peut construire ce tableau de variation :</p>
            <img
              src={table5}
          ...
          <li>
            ...
            <p>
              Prenons un exemple : <InlineMath math="f(x) = x^2 + x + 1" />
            </p>
            <p>Calculons le discriminant :</p>
            <BlockMath math="\Delta = b^2 - 4ac = 1^2 - 4(1)(1) = 1 - 4 = -3" />
            <p>
              Le discriminant est négatif, donc il n'y a pas de racines réelles.
            </p>
            <p>On peut construire ce tableau de variation :</p>
            <img
              src={table7}
