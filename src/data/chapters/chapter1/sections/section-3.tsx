      ...
      <section className="section">
        ...
        <ol className="list list-1" type="1">
          <li>
            ...
            <p>
              L'axe de symétrie <i>semble</i> se trouver à{" "}
              <InlineMath math="x = -7" />.
            </p>
          </li>
          <li>
            ...
            <p>
              On sait que l'axe de symétrie passe par la même abscisse que le
              sommet.
            </p>
            <p>
              Si l'on connaît la forme développée{" "}
              <InlineMath math="f(x) = ax^2 + bx + c" />, l'abscisse du sommet
              est <InlineMath math="x_S = \alpha = \frac{-b}{2a}" />.
            </p>
            <p>
            ...
            />
            <p>
              L'axe de symétrie est donc la droite <InlineMath math="x = 2" />.
            </p>
          </li>
        </ol>
      </section>
