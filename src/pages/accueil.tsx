...
export default function Accueil(): React.JSX.Element {
  return (
    <main
      id="haut-de-page"
      className="min-h-screen bg-background text-text mx-auto max-w-[860px] ml-16 px-6 pt-16 pb-20 sm:ml-0 sm:px-4 sm:pt-8"
    >
      <Hero />
      ...
      <section className="mt-14 bg-white p-9 rounded-2xl shadow-[0_18px_60px_rgba(31,35,53,0.08)]">
        ...
        <ul className="m-0 pl-5 text-muted leading-8 list-disc">
