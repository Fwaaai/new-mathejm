...
export default function Exercise04(): React.JSX.Element {
  return (
    <main>
      <header className="intro">
        <nav className="breadcrumb" aria-label="Fil d'Ariane">
          ...
          <span className="breadcrumb__separator" aria-hidden="true">›</span>
          <span className="breadcrumb__current">Exercice 4 - Forme développée</span>
        </nav>
        <h1 className="intro-title">Forme développée</h1>
        <p className="intro-lead">Exercice 4 du Chapitre 1</p>
      </header>
