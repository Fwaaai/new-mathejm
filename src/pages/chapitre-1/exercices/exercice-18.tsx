...
export default function Exercise18(): React.JSX.Element {
  return (
    <main>
      <header className="intro">
        <nav className="breadcrumb" aria-label="Fil d'Ariane">
          ...
          <span className="breadcrumb__separator" aria-hidden="true">›</span>
          <span className="breadcrumb__current">Exercice 18 - Forme développée</span>
        </nav>
        <h1 className="intro-title">Forme développée</h1>
        <p className="intro-lead">Exercice 18 du Chapitre 1</p>
      </header>
