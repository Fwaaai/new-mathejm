...
export default function Section15(): React.JSX.Element {
  return (
    <main>
      <header className="intro">
        <nav className="breadcrumb" aria-label="Fil d'Ariane">
          ...
          <span className="breadcrumb__separator" aria-hidden="true">›</span>
          <span className="breadcrumb__current">Section 15</span>
        </nav>
        <h1 className="intro-title">Section 15</h1>
        <p className="intro-lead">Section 15 du Chapitre 1</p>
      </header>
