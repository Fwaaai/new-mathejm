...
export default function Chap1(): React.JSX.Element {
  const sections = [
      ...
      },
      {
        id: 'section-19',
        number: 'Section 19',
        title: 'Résolution d’inéquation se ramenant à des facteurs du 1er ou 2nd degré',
      },
    ]
  return (
    <main>
      <header className ="intro">
        ...
        <p className = "intro-lead">Retrouvez ici les 19 sections pour le premier chapitre.</p>
      ...
      <section className="mt-10 flex flex-col gap-6">
        {sections.map((section) => (
          <a key={section.id} href={`#${section.id}`} className="section-card">
